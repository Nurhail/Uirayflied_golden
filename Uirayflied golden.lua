...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Golden = {
			...
			SelectedTabTextColor = Color3.fromRGB(34, 34, 34),
			ElementBackground = Color3.fromRGB(15, 15, 15),
			ElementBackgroundHover = Color3.fromRGB(20, 20, 20),
			SecondaryElementBackground = Color3.fromRGB(10, 10, 10),
			ElementStroke = Color3.fromRGB(26, 26, 26),
			SecondaryElementStroke = Color3.fromRGB(20, 20, 20),
			SliderBackground = Color3.fromRGB(200, 134, 10),
			SliderProgress = Color3.fromRGB(200, 134, 10),
			SliderStroke = Color3.fromRGB(245, 180, 0),
			ToggleBackground = Color3.fromRGB(10, 10, 10),
			ToggleEnabled = Color3.fromRGB(200, 134, 10),
			ToggleDisabled = Color3.fromRGB(58, 58, 58),
			ToggleEnabledStroke = Color3.fromRGB(245, 180, 0),
			ToggleDisabledStroke = Color3.fromRGB(85, 85, 85),
			ToggleEnabledOuterStroke = Color3.fromRGB(80, 50, 5),
			...
			PlaceholderColor = Color3.fromRGB(255, 215, 0)
		},
